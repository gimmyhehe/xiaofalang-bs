...
const toolbar = ['undo redo | template | formatselect  | bold italic  strikethrough fontsizeselect forecolor backcolor | link | alignleft aligncenter alignright alignjustify  | numlist bullist outdent indent  | removeformat code']
