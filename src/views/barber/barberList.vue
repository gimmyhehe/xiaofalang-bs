  ...
  <div class="m-barber-list" v-loading.body="loading">
    <div class="g-search-box">
      <el-form :inline="true" :model="params" class="demo-form-inline" @keyup.enter.native="getList({})" >
        <el-form-item>
          <el-input v-model.trim="params.q.name" placeholder="发型师名称"></el-input>
        </el-form-item>
        <el-form-item>
      ...
      <div class="search-right">
        <el-button type="primary" @click="$router.push('add')">新增发型师</el-button>
      </div>
    </div>
    <template v-if="tableData">
      <el-table
        ...
        style="width: 100%;"
        >
        <el-table-column prop="hairstyle_name" label="姓名" align="center"></el-table-column>
        <el-table-column prop="hairstyle_level" label="职称" align="center"></el-table-column>
        <el-table-column prop="hairstyle_intr" label="简介" align="center"></el-table-column>
        ...
        <el-table-column :label="$t('operation')" align="center" fixed="right">
          <template slot-scope="scope">
            ...
            <el-button type="primary"
              class="btn-style"
              @click="$router.push(`/page/barber/edit/${scope.row.hairstyle_id}`)">
...
import { scanhairstyle } from '@/api/barber'
...
export default {
  ...
  methods: {
    getList () {
      ...
      scanhairstyle({company_id}).then(res=>{
        console.log(res)
        this.tableData = res.hairstylist
        this.loading = false
      })
    },
